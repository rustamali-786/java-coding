...
public class TwoDArray {
    ...
    static void findprefixsummatrix(int [][] matrix) {
        ...
        // trverse horizontally to calculate ro wise prefix sum.
        for (int i = 0; i < r; i++) {
            for (int j = 1; j < c; j++) {
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Enter np of rows and col : ");
        int r = sc.nextInt();
        int c = sc.nextInt();
        int [][] matrix = new int [r][c];
        System.out.println("Enter" +r*c +" elements : ");
        ...
        System.out.println("Enter recangle boundries l1, r1, l2, r2 ");
        int l1 = sc.nextInt();
        int r1 = sc.nextInt();
        int l2 = sc.nextInt();
        int r2 = sc.nextInt();
